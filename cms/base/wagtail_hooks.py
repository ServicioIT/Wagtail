...
from cms.base.models import FooterText, Person
...
class ShopSnippetViewSetGroup(SnippetViewSetGroup):
    menu_label = "Miscelaneos"
    menu_icon = "regex"  # change as required
...
register_snippet(ShopSnippetViewSetGroup)
