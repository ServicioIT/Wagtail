...
class GenericSettings(ClusterableModel, BaseGenericSetting):
    ...
    organisation_url = models.URLField(verbose_name="URL", blank=True)
...
class SiteSettings(BaseSiteSetting):
    title_suffix = models.CharField(
        verbose_name="Título de sitio",
        max_length=255,
        help_text="The suffix for the title meta tag e.g. ' | The Wagtail CMS'",
        default="The Wagtail CMS",
    )
